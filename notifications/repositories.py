...
class NotificationRepositoryProtocol(Protocol):
    ...
    def update(self, notification: AnyNotificationEntityType) -> None:
        ...

    def get(self, uuid: str | UUID) -> AnyNotificationEntityType:
        ...
...
class DjangoNotificationRepository(NotificationRepositoryProtocol):
    def _get_details(self, notification: AnyNotificationEntityType) -> dict:
        """
        Details are Notification Type specific fields. So everything that it is non-standard notification field.
        """
